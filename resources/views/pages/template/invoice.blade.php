            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 17.5%;" class="right">Egységár (nettó)</th>
        ...
        <div class="summary-section">
            <table class="summary-table">
                <tr>
                    ...
                    <td class="summary-value">{{ $grand_total }} Ft</td>
                </tr>
                <tr>
                    <td class="summary-label">ÁFA (0%):</td>
                    <td class="summary-value">0 Ft</td>
                </tr>
                <tr class="total-row">
